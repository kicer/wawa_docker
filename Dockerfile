...
# zeroc-ice
RUN yum install -y gcc-c++ ice-all-runtime ice-all-devel && yum clean all && pip3.6 install zeroc-ice==3.5 --trusted-host mirrors.aliyun.com -i http://mirrors.aliyun.com/pypi/simple
# 额外的扩展库
